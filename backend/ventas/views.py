...
from .serializers import DetalleVentaSerializer, VentaSerializer
...
class VentaViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        numero_comprobante = parametros.get('numero_comprobante')
        buscar = parametros.get('buscar', '').strip()
        ...
        if numero_comprobante:
            queryset = queryset.filter(
                numero_comprobante__icontains=numero_comprobante
            )
...
class DetalleVentaViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if venta_id and str(venta_id).isdigit():
